...
import { VirtualGridRenderItem, VirtualGridOptions } from './useVirtualGrid';
 ...
 *```
 */
export declare const VirtualGrid: import("../../utils/forwardRef").FunctionComponentWithAs<"div", VirtualGridProps>;
